					...
					<div class="content">
    					<div class="main">
							<section class="main-content">
								<div class="stripe">
									<div class="content">
										<section id="requestinfo" class="schedule opt1">
											<header><?php the_title(); ?></header>
											<div class="content">
												<div class="section-desc">
													<?php the_content(); ?>
												</div><!-- section-desc -->
												<div class="row clearfix hidden-xs hidden-sm images">
													<div class="col-3">
														<img src="<?php echo content_url(); ?>/img/SudentLife1.jpg" alt="medical students" class="opt2">
													</div><!-- col-3 -->
													<div class="col-3">
														<img src="<?php echo content_url(); ?>/img/Teaching1.jpg" alt="medical assistant" class="opt2">
													</div><!-- col-3 -->
													<div class="col-3">
														<img src="<?php echo content_url(); ?>/img/Teaching2.jpg" alt="dental assistant" class="opt2">
													</div><!-- col-3 -->
													<div class="col-3">
														<img src="<?php echo content_url(); ?>/img/Teaching3.jpg" alt="surgical technician" class="opt2">
													</div><!-- col-3 -->
													<div class="col-3">
														<img src="<?php echo content_url(); ?>/img/camp1_0.jpg" alt="Sunny afternoon on a Concorde campus." class="opt1">
													</div><!-- col-3 -->
													<div class="col-3">
														<img src="<?php echo content_url(); ?>/img/camp2_1.jpg" alt="Sunny afternoon on a Concorde campus." class="opt1">
													</div><!-- col-3 -->
													<div class="col-3">
														<img src="<?php echo content_url(); ?>/img/camp3_0.jpg" alt="Sunny afternoon on a Concorde campus." class="opt1">
													</div><!-- col-3 -->
													<div class="col-3">
														<img src="<?php echo content_url(); ?>/img/camp4.jpg" alt="Sunny afternoon on a Concorde campus." class="opt1">
													</div><!-- col-3 -->
												</div><!-- row -->
