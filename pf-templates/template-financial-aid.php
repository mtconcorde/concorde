...
<main id="main">
	<div id="content_top" class="region top">
		<div class="content clearfix">
			<div id="block-block-2463" class="block block-block ">
				<div class="content">
					<div class="row clearfix">
						<div class="banner-image col-8 col-md-6 col-sm-12 f-img"></div>
							<div class="col-4 col-md-6 col-sm-12">
								<section id="innerrequestinfo" class="block block-block requestinfo onestepform hidden-sm hidden-xs">
